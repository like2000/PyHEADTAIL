...
from trackers.longitudinal_tracker2 import *
...
cavity = RFSystems(C, [4620], [RFvoltage], [0.], [alpha_0], gamma)


# Beam
bunch = Particles.as_gaussian(n_macroparticles, e, gamma, intensity, m_p, alpha_x, beta_x, epsn_x, alpha_y, beta_y, epsn_y, beta_z, epsn_z, cavity.is_in_separatrix)
