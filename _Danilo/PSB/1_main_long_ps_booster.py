...
bunchmonitor = BunchMonitor('beam_closed', n_turns+1, statistics = "Longitudinal")
...
for i in range(n_turns):
    ...
    if ((i+1) % n_turns_between_two_plots) == 0:
        ...
        - 1e1, 1e1, xunit = 'ns', sampling = 10, separatrix_plot = True, dirname = 'figCL')
         
        plot_induced_voltage_vs_bins_centers(i+1, general_params, total_induced_voltage, style = '-', dirname = 'figCL')
          
        plot_beam_profile(i+1, general_params, slice_beam, dirname = 'figCL')
...
plot_bunch_length_evol(my_beam, 'beam_closed', general_params, n_turns, dirname = 'figCL')
plot_position_evol(n_turns, my_beam, 'beam_closed', general_params, unit = None, dirname = 'figCL')
