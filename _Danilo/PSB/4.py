...
bunchmonitor = BunchMonitor('4', n_turns+1, statistics = "Longitudinal")
...
#         
        ...
        - 1e1, 1e1, xunit = 'ns', sampling = 10, separatrix_plot = True, dirname = '4_figCL')
          
        plot_induced_voltage_vs_bins_centers(i+1, general_params, total_induced_voltage, 
                                             style = '-', dirname = '4_figCL')
           
        plot_beam_profile(i+1, general_params, slice_beam, dirname = '4_figCL')
...
#            cut_right = 0.1e8)
plot_bunch_length_evol(my_beam, '4', general_params, n_turns, dirname = '4_figCL')
plot_position_evol(n_turns, my_beam, '4', general_params, unit = None, dirname = '4_figCL')
