...
bunchmonitor = BunchMonitor('5', n_turns+1, statistics = "Longitudinal")
...
#         
        ...
        - 1e1, 1e1, xunit = 'ns', sampling = 10, separatrix_plot = True, dirname = '5_figSH')
          
        plot_induced_voltage_vs_bins_centers(i+1, general_params, total_induced_voltage, 
                                             style = '-', dirname = '5_figSH')
           
        plot_beam_profile(i+1, general_params, slice_beam, dirname = '5_figSH')
...
#            cut_right = 0.1e8)
plot_bunch_length_evol(my_beam, '5', general_params, n_turns, dirname = '5_figSH')
plot_position_evol(n_turns, my_beam, '5', general_params, unit = None, dirname = '5_figSH')
