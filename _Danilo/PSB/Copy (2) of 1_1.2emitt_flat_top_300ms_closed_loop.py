...
# cavity C04
cavity_04 = Resonators(430, 8*1e6, 6.8)

# cavity C16
cavity_16 = Resonators(600, 16*1e6, 30)

# INDUCED VOLTAGE FROM IMPEDANCE------------------------------------------------

imp_list = [cavity_02, cavity_04, cavity_16]

ind_volt_freq = InducedVoltageTime(slice_beam, imp_list)
...
ax.plot(cavity_02.time_array, cavity_02.wake, cavity_04.time_array, cavity_04.wake, cavity_16.time_array, cavity_16.wake, linewidth = 2)
ax.set_xlabel('Time [s]', fontsize=20, fontweight='bold')
ax.set_ylabel('Wake field [1/F]', fontsize=20, fontweight='bold')
